		    ...
		    <div class=" promo_dets" v-for="promo in events">
    			<div class="page_container row">
    				...
    				<div class="col-sm-12 promo_div_dets text-left">
    					...
    					<p class="promo_div_date">{{promo.publish_date | moment("MMM D", timezone)}} - {{promo.end_date | moment("MMM D", timezone)}}</p>
...
<script>
    define(["Vue", "vuex", "moment", "moment-timezone", "vue-moment", "vue-meta", "vue-lazy-load"], function(Vue, Vuex, moment, tz, VueMoment, Meta, VueLazyload) {
        Vue.use(Meta);
        Vue.use(VueLazyload);
        return Vue.component("noticeboard-component", {
            ...
            computed: {
                ...
                events() {
                    ...
                    if(blogs && blogs.posts){
                        ...
                        _.sortBy(temp_promo, [function(o) { return o.publish_date; }]);
                    }
                    return temp_promo;
                }
            }
