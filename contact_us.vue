        ...
        <div class="margin_25_across padding_top_40" id="contact_us_container">
            <div class="row"> 
                <div class="col-sm-8 contact_contents">
                    <img v-if="sideImage" style="margin-bottom:20px;"  :src='sideImage.image_url' alt="">
            ...
            methods: {
                ...
                loadData: async function() {
                    try {
                        ...
                        let results = await Promise.all([this.$store.dispatch('LOAD_PAGE_DATA', {url: host_name + "/pages/rollinghills-contact-us.json"}), this.$store.dispatch("getData", "repos")]);
                        return results;
                    } catch (e) {
