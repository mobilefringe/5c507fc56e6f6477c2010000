            			...
            			<div v-for="(result,index) in searchResults" :key="index">
                            <div class="row result_container_row">
                                <div v-if="result.is_store" class="col-sm-3 store_details_image center-block">
                                    ...
                                    <div class="no_logo">
                                        ...
                                        <p class="store_details_name">
                                            ...
                                            <span v-else>{{ result.store.name }} <span v-if="result.store.name_2"><br>({{result.store.name_2}})</span></span>
                                        </p>
                                    </div>    
                                </div> 
                                <div v-else>
                                ...
                                <div class="col-sm-9 search_result_content">
                                    <h1 v-if="result.store_front_url_abs">{{result.name}}<span v-if="result.name_2"><br>({{result.name_2}})</span></h1>
                                    <h1 v-else>{{result.name}}</h1>
