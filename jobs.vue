				...
				<div class="col-sm-5 promo_div_dets text-left">
					...
					<div class="promo_feature_share row is-table-row">
    					...
    					<div class="text-right  col-sm-6" v-if="promo">
        					<social-sharing :url="$root.shareURL(promo.slug)" :title="promo.title" :description="promo.body" :quote="_.truncate(promo.description, {'length': 99})" twitter-user="" :media="promo.image_url" inline-template >
