	...
	<div class="event_dets_container page_container" v-if="currentEvent">
		<div class="row">
			...
			<div class="col-sm-8 event_image_container text-left">
    			...
    			<social-sharing :url="$root.shareURL('events',currentEvent.slug)" :title="currentPromo.title" :description="currentPromo.body" :quote="_.truncate(currentPromo.description, {'length': 99})" twitter-user="" :media="currentPromo.image_url" inline-template >
