		...
		<div class="row">
			<div class="col-md-4 store_details_container">
				<div>
					...
					<p> <span v-if="currentStore.unit"><strong>Unit #:</strong> {{currentStore.unit}}</span><span v-if="currentStore.z_coordinate"><strong> Level:</strong> {{currentStore.z_coordinate}}</span></p>
