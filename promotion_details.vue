		...
		<div class="row page_container">
			<div class="col-sm-4 event_logo_container">
				...
				<div style="margin-left:0; margin-top: 25px;">
					...
					<router-link :to="'/stores/'+currentPromo.store.slug"><p class="promo_store_name">{{currentPromo.store.name}} <span v-if="currentPromo.store.name_2">({{promo.store.name_2}})</span></p></router-link>
