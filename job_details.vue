		...
		<div class="row page_container">
			<div class="col-sm-4 job_logo_container">
				<div>
                  ...
                  <div v-else class="no_logo_container hidden_phone">
                    ...
                    >
                        ...
                        <span v-if="currentJob.store.name_2"><br>({{currentJob.store.name_2}})</span>
				...
				<div style="margin-left:0; margin-top: 25px;">
    				...
    				<p class="job_div_date">{{currentJob.start_date | moment("MMM D, YYYY", timezone)}} - {{currentJob.end_date | moment("MMM D, YYYY", timezone)}}</p>
				</div>
			</div>
